...
function Footer() {
    return (
        <footer id="footer" className="bg-black px-4 sm:px-6 md:px-12 lg:px-24 py-8 sm:py-12 md:py-16">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
                    ...
                    <div className="col-span-1 sm:col-span-2 lg:col-span-1 flex flex-col items-center sm:items-start">
                        ...
                        />
                        <p className="text-gray-400 text-sm sm:text-base text-center sm:text-left leading-relaxed">
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                        <h2 className="text-xl sm:text-2xl text-white font-bold mb-4 text-orange-500">Links</h2>
                    ...
                    {/* Contact Section */}
                    <div className="flex flex-col items-center sm:items-start">
                        <h2 className="text-xl sm:text-2xl text-white font-bold mb-4 text-orange-500">Contáctame</h2>
                    ...
                    <div className="col-span-1 sm:col-span-2 lg:col-span-1">
                        <h2 className="text-xl sm:text-2xl text-white font-bold mb-4 text-orange-500 text-center lg:text-left">
                            Ubicación
                        </h2>
                        <div className="relative w-full h-48 sm:h-56 lg:h-48 rounded-lg overflow-hidden shadow-lg">
                            <iframe
                ...
                <div className="border-t border-gray-800 pt-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p className="text-gray-400 text-sm text-center sm:text-left">
                            © 2025 Marcelo Todesco - Maestro Mayor de Obras. Todos los derechos reservados.
                        </p>
